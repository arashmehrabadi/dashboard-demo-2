    ...
    constructor({
        ...
        this.CriarDivBase = function () {
            ...
            document.getElementById("main_" + randomID).addEventListener("click", function () {
                document.getElementById("main_" + randomID).style.backgroundColor = "white";

                // Reset dropdown position, in case it was changed before
                document.getElementById("ul_" + randomID).style.position = "absolute";
                document.getElementById("ul_" + randomID).style.zIndex = "200";
                // document.getElementById("bv_" + randomID).style.zIndex = "200";
                document.getElementById("bv_" + randomID).style.background = "linear-gradient(90deg, #FEA90C 0%, #F74B49 100%)";
        ...
        function FixVerticalViewPort() {
            ...
            if (Math.round(currentElementView + 50) > Math.round(currentWindowView)) {
                ...
                document.getElementById("ul_" + randomID).style.position = "absolute";
                document.getElementById("ul_" + randomID).style.top = "50px";
        ...
        document.addEventListener("click", function (e) {
            if (!e.target.closest(".bv_ul_inner") || !event.target.classList.contains('bv_input')) {
                document.getElementById("bv_" + randomID).style.background = "transparent";
                document.getElementById("main_" + randomID).style.backgroundColor = "#F8F8F8";
